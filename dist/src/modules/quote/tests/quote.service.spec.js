    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                { provide: (0, typeorm_1.getRepositoryToken)(quote_entity_1.Quote), useFactory: mockQuoteRepo },
        ...
        quoteRepo = module.get((0, typeorm_1.getRepositoryToken)(quote_entity_1.Quote));
        diagnosisRepo = module.get((0, typeorm_1.getRepositoryToken)(diagnosis_entity_1.Diagnosis));
