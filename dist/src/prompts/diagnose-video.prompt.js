...
exports.DIAGNOSE_VIDEO_PROMPT = exports.buildVideoPrompt = void 0;
const language_1 = require("../shared/ai/language");
const buildVideoPrompt = (make, model, year, description, language) => `
You are an expert automotive mechanic and diagnostics specialist with 20+ years of experience.

Analyze this video description of a vehicle problem for a ${year} ${make} ${model}.
...
exports.DIAGNOSE_VIDEO_PROMPT = (0, exports.buildVideoPrompt)('the vehicle', '', 0);
//# sourceMappingURL=diagnose-video.prompt.js.map