...
exports.DIAGNOSE_IMAGE_PROMPT = exports.buildImagePrompt = void 0;
const language_1 = require("../shared/ai/language");
const buildImagePrompt = (make, model, year, description, language) => {
...
exports.DIAGNOSE_IMAGE_PROMPT = (0, exports.buildImagePrompt)('the vehicle', '', 0);
//# sourceMappingURL=diagnose-image.prompt.js.map